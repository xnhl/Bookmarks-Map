...
let final_data = parsed.children.map(child => mapData(child))
...
writeHTML("../final/firefox/index", makeHTML(elements))
writeMD("../final/firefox/index", makeHTML(elements_markdown))
